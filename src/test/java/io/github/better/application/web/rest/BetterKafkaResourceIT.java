...
public class BetterKafkaResourceIT {
    ...
    @BeforeEach
    public void setup() {
        BetterKafkaResource kafkaResource = new BetterKafkaResource(kafkaProducer);
    ...
    public void sendMessageToKafkaTopic() throws Exception {
        restMockMvc.perform(post("/api/better-kafka/publish?message=yolo"))
